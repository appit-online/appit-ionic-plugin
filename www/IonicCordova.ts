...
export interface IDeployConfig {
  ...
  /**
   * The [Ionic Pro](https://ionpush.appit-online.de/#/docs/create-app) app id.
   */
  appId?: string;
  ...
  /**
   * The [channel](https://ionpush.appit-online.de/#/docs/create-channel) that the plugin should listen for updates on.
   */
  channel?: string;
